...
import checklyLogo from "@/public/integrations/checkly/checkly-logo-dark-mode.svg";
...
const integrations = [
	...
	},
	{
		name: "Updown.io",
		icon: (
			<Image alt="updown.io logo" width={32} height={32} src={updownLogo} />
		),
		description: "Automate incident creation/resolution using Updown.io.",
	},
	{
		name: "Checkly",
		icon: <Image alt="checkly logo" width={32} height={32} src={checklyLogo} />,
