            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 onClick={(e) =>{ window.navigator.clipboard.writeText(`${process.env.NEXT_PUBLIC_BASE_URL}/api/incidents/webhooks/${monitor.uptimeChecker?.toLocaleLowerCase()}/${monitor.id}`); toast.info("Webhook URL copied to clipboard"); }} className="font-semibold text-slate-900">{monitor.name}</h3>
